...
- **2026-08-21 로컬 백업 착수**(§3 #23 · §14 P — 무료): 문서 선행([`docs/BACKUP_SYSTEM.md`](./docs/BACKUP_SYSTEM.md)) → expo-file-system/sharing/document-picker → `features/backup` → `/backup` 화면 → 약관 5차·처리방침 4차 개정(재게시는 사용자 확인 후) → 다음 AAB vc6.
