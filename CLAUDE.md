...
- 다음 단계: **2026-08-24 Phase 11(소프트 업데이트 + 검색 힌트) → vc8 · 1.0.7** → vc7 검토 결과 대기 → (AdMob 해제 후) Phase 7(Remove Ads) → ≈8/31 프로덕션 신청(선행 확인 3개). 전체 로드맵은 [`docs/PLAN.md`](./docs/PLAN.md) "남은 작업 로드맵".
