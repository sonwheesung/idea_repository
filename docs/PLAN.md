...
| 8 | 출시 준비 — 아이콘/스플래시 · 처리방침 · 데이터 보안 선언 · AAB · 스토어 | 🔨 2026-08-17 — 아이콘·그래픽·처리방침 게시·데이터 보안·스토어 등록정보·AAB 검토 전송 ✅ · vc1 검토 통과(테스터 제공 중) · 2026-08-18 vc2(1.0.1) 빌드 → 업로드 화면(사용자 업로드) / ⏳ `play-store-launch-checklist` 최종 점검·프로덕션 신청(14일 후) |
