...
- ~~⏳ 사용자에게 닿는 배포는 사용자 지시 대기.~~ → ✅ **2026-09-14 18:24 KST 첫 OTA로 게시**(사용자 지시 "ota 배포로 하자"). 채널 `production` · runtimeVersion `1.0.0` · 그룹 `12347226-9aa3`. 게시·전달 실측은 `BUILD.md` §5 ota 행.
