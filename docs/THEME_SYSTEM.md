...
| 선택 UX(Settings → Theme, 토큰 미니어처 그리드 + "시스템" 항목) | ✅ 2026-08-17 |
| 선택 로컬 저장(zustand persist) — 깨진 저장값은 system 폴백 | ✅ 2026-08-17 |
| 상태바·스택 헤더 토큰 연동 | ✅ |
...
[ System (auto) ]                       ← 첫 항목. OS 라이트/다크 → Light/Dark Minimal
┌──────────┐ ┌──────────┐
